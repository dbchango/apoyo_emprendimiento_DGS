@section('title', __('Requisito Cumplidos'))
						...
						<tbody>
							...
							<tr>
								...
								<div class="btn-group">
									...
									<a class="dropdown-item" onclick="confirm('Confirm Delete Requisito Cumplido id {{$row->id}}? \nDeleted Requisito Cumplidos cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Delete </a>
									</div>
								</div>
								</td>
							@endforeach
