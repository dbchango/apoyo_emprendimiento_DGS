@section('title', __('Pre Requisitos'))
						...
						<tbody>
							...
							<tr>
								...
								<div class="btn-group">
									...
									<a class="dropdown-item" onclick="confirm('Confirm Delete Pre Requisito id {{$row->id}}? \nDeleted Pre Requisitos cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Delete </a>
									</div>
								</div>
								</td>
							@endforeach
